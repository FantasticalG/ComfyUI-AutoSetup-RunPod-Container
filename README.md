...
- ComfyUI and extension versions are kept in sync using a given target date. The date of the latest commit in the setup script is the default.
...
| TARGET_DATE | Target-date for deterministic installs |
